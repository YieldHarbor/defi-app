    ...
    return (
        ...
        >
            ...
            <p class="  text-sm text-gray-300  mt-2">
                Deposit your Staked SUI to convert it into Principal Tokens (HYT), which locks in a fixed yield until the end of the period.
            </p>
            <div className="border rounded-lg mt-4   p-4 border-gray-400">
                <div className="flex items-center">
                    <img src={"./sui-sui-logo.svg"} alt="" className="h-3 w-3  mt-auto mb-auto  mr-2 flex-shrink-0 rounded-full" />
            ...
            <div className="border rounded-lg mt-4 p-4 border-gray-400">
                ...
                <div class="flex mb-2">
                    <select id="large" value={ss} onChange={(e) => setSS(e.target.value)} class="block w-full px-4 py-3 text-base text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-transparent dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
            ...
            <div className="border rounded-lg mt-4 p-4 border-gray-400">
                <div class="mt-2 flex flex-row">
                    ...
                    <span class="ml-auto bg-blue-100 text-blue-800 text-xs font-medium mr-2 px-2.5 py-0.5 rounded dark:bg-blue-900 dark:text-black">
                        1 Staked SUI = {(1 + profit[0]).toLocaleString()} HYT
                    </span>
                </div>
                ...
                />
                <hr class="h-px my-4 border-0 bg-gray-600" />
                <button disabled={loading} onClick={() => onStake(ss)} className=" py-3 rounded-lg pl-10 pr-10 text-sm font-medium flex flex-row w-full justify-center bg-gradient-to-l from-purple-400 to-green-400">
                    {loading && <Spinner />}
                    Mint
                </button>
            </div>
