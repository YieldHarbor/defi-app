...
export const Sell = ({ tick, setTick }) => {
    ...
    const { getPTBalance, getAllVaultTokens, createOrder } = useYieldHarbor()
    ...
    return (
        <div>
            ...
            <div class="relative mt-1">
                ...
                <input value={amount} onChange={(e) => setAmount(e.target.value)} type="number" id="amount" class="[appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none block w-full py-3  text-sm pl-[120px] border rounded-lg      bg-transparent  border-gray-600  placeholder-gray-400  text-white  focus:ring-blue-500  focus:border-blue-500" />
                <button onClick={() => setAmount(Number(bal))} class="text-white absolute right-1.5 bottom-1.5  font-medium rounded-lg text-sm px-4 py-2  bg-blue-600  hover:bg-gradient-to-l from-purple-400 to-green-400  focus:ring-blue-800">Max</button>
            </div>
            <div class="grid grid-cols-2 gap-3 mt-1   ">
                <div class="col-span-1 flex flex-col">
                    ...
                    <div class="relative mt-1">
                        ...
                        }} type="number" id="price" class=" block w-full py-3  text-sm pl-[45px] border rounded-lg bg-transparent  border-gray-600  placeholder-gray-400  text-white  focus:ring-blue-500  focus:border-blue-500" />
                    </div>
                </div>
                <div class="col-span-1 flex flex-col">
                    <div className="block text-sm font-medium leading-6 mt-2 text-gray-300">
                    ...
                    <div class="relative mt-1">
                        <input value={discount.toLocaleString()} type="number" id="price" class="[appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none block w-full py-3  text-sm pl-[20px] border rounded-lg bg-transparent  border-gray-600  placeholder-gray-400  text-white  focus:ring-blue-500  focus:border-blue-500" />
            ...
            <button onClick={onCreateOrder} disabled={loading} className="  py-3 rounded-lg pl-10 pr-10 text-sm font-medium flex flex-row w-full justify-center bg-gradient-to-l from-purple-400 to-green-400">
                {loading && <Spinner />}
                Add Now
            </button>
        </div>
        ...
        <div>
            <div className="block mt-4 text-sm font-medium leading-6 text-gray-300">
                ...
                <div class="relative mt-1">
                    ...
                    <input value={0} type="number" id="amount" class="[appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none block w-full py-3  text-sm pl-[120px] border rounded-lg      bg-transparent  border-gray-600  placeholder-gray-400  text-white  focus:ring-blue-500  focus:border-blue-500" />
                ...
                <div class="grid grid-cols-2 gap-3 mt-1   ">
                    <div class="col-span-1 flex flex-col">
                        ...
                        <div class="relative mt-1">
                            ...
                            <input value={0} type="number" id="price" class=" block w-full py-3  text-sm pl-[45px] border rounded-lg bg-transparent  border-gray-600  placeholder-gray-400  text-white  focus:ring-blue-500  focus:border-blue-500" />
                        </div>
                    </div>
                    <div class="col-span-1 flex flex-col">
                        <div className="block text-sm font-medium leading-6 mt-2 text-gray-300">
                        ...
                        <div class="relative mt-1">
                            <input value={0} type="number" id="price" class="[appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none block w-full py-3  text-sm pl-[20px] border rounded-lg bg-transparent  border-gray-600  placeholder-gray-400  text-white  focus:ring-blue-500  focus:border-blue-500" />
                            <div class="absolute inset-y-0 right-0 flex items-center pr-3 pointer-events-none">
                                <span class=" text-sm text-gray-300" >
                                    %
                                </span>
            ...
            <hr class="my-5 h-[1px] border-t-0 bg-neutral-100  opacity-50" />
            <button onClick={() => alert("Creating a buy order is not available")} className="  py-3 rounded-lg pl-10 pr-10 text-sm font-medium flex flex-row w-full justify-center bg-gradient-to-l from-purple-400 to-green-400">
                Add Now
            </button>
        </div>
    )
            ...
            <div className="container mx-auto">
                <div class="wrapper">
                    <p class="text-black text-sm p-5 text-center">
                        Where you can trade HYT and YT with ease
                    </p>
                    <div class="grid grid-cols-10 gap-3 px-2">
                        <div class="col-span-2">

                            <div class="border p-5 m-1 bg-black border-gray-600">
...
const HYT = () => {
    ...
    const { getAllOrders, buy } = useYieldHarbor()
    ...
    return (
        <div>
            <CreateOrder
                ...
                setTick={setTick}
            />
            <div class="max-w-xl border p-5 m-1 bg-black border-gray-600">
                ...
                <div class="max-w-xl ml-auto mr-auto">
                    <hr class="my-5 h-[1px] border-t-0 bg-neutral-100  opacity-50" />
                    <button onClick={() => setCreateOrderPanel(true)} className="  py-3 rounded-lg pl-10 pr-10 text-sm font-medium flex flex-row w-full justify-center bg-gradient-to-l from-purple-400 to-green-400 .">
                        Create Order
